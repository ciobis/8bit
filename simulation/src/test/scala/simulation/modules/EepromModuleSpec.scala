...
class EepromModuleSpec extends AnyFeatureSpec with GivenWhenThen with BeforeAndAfter {
  ...
  before {
    ...
    eeprom = new EepromModule(a0C, a1C, a2C, a3C, a4C, a5C, a6C, a7C, a8C, a9C, a10C, io0C, io1C, io2C, io3C, io4C, io5C, io6C, io7C, oeC)
  }

  Feature("EEProm module") {

    Scenario("Read") {
      val addr1 = overflowInt[Bit16](5)
      val addr2 = overflowInt[Bit16](123)
